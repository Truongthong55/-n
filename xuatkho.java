...
public class xuatkho extends khovattuxaydung {
    ...
    private double soLuongXuat,thanhTien;


public xuatkho(String tenVatTu, String maVatTu, String maPhieuXuat, double soLuongXuat, String ngayXuat, double thanhTien){
...
//         String ngayXuat = sc.next();
//         xuatkho xk = new xuatkho(maPhieuXuat, ngayXuat);
//         list.add(xk);
//     }

//     System.out.println("Đa them vat tu vao danh sach.");
// }
// NHẬP DANH SÁCH NHẬP KHO
