...
public class nhapkho  extends khovattuxaydung {
    ...
    private double  soLuongNhap, thanhTien;
    private String ngayNhap, maPhieuNhap;

    public nhapkho (String tenVatTu, String maVatTu, String maPhieuNhap, String  ngayNhap,double soLuongNhap, double thanhTien){
